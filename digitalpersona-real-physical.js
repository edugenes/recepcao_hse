/**
 * Cliente Real DigitalPersona 4500 - Ativação FÍSICA REAL do Leitor
...
class DigitalPersonaRealPhysical {
  constructor() {
    this.ws = null;
    this.server = null;
  ...
  async activateReader(ws) {
    try {
      console.log('🖐️ ATIVANDO LEITOR DIGITALPERSONA 4500 FISICAMENTE...');
...
if (require.main === module) {
  const client = new DigitalPersonaRealPhysical();
  client.startServer();
...
module.exports = DigitalPersonaRealPhysical;
